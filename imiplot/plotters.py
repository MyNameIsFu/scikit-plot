...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.metrics.plot_confusion_matrix instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.metrics.plot_roc_curve instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.metrics.plot_ks_statistic instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.metrics.plot_precision_recall_curve instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.estimators.plot_feature_importances instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.estimators.plot_learning_curve instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.metrics.plot_silhouette instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.cluster.plot_elbow_curve instead.')
...
@deprecated('This will be removed in v0.4.0. Please use '
            'imiplot.decomposition.plot_pca_component_variance instead.')
